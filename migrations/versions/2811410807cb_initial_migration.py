...
Revision ID: 2811410807cb
Revises:
Create Date: 2025-08-11 11:08:33.348527
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("UNFINISHED", "COMPLETED", name="statusinvoiceenum"),
            nullable=False,
        ),
        sa.Column("total_amount", sa.Integer(), nullable=False),
        sa.Column("payment_time", sa.DateTime(timezone=True), nullable=True),

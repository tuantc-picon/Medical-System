...
from app.users.schemas.role import RolePermissionCreate, RolePermissionRead


class RoleService(BaseService):

    async def assign_role_permission(self, data: RolePermissionCreate):
        try:
            ...
            data_return = RolePermissionRead(
                role_id=data.role_id,
